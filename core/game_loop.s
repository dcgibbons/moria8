...
!prompt:
#if PLATFORM_REQUIRES_MEDIA_PROBE
    lda program_device
...
platform_restore_generation_overlay:
    lda current_overlay
    cmp #OVL_DUNGEON_GEN
    beq !crgo_done+
    lda #OVL_DUNGEON_GEN
...
#import "player_dig_ability.s"
#if !BANKED_EGO_DESC_HELPERS_EXTERNAL
#import "item_desc_ego_helpers.s"
#endif

#importonce
// test_confusion128.s — Focused C128 coverage for the Confusion row
...
test_start:
    ...
    :PatchJump(tramp_spell_execute_selected, test_tramp_confusion_execute)
...
!t1_fail:
    ...
    // message and still marks the spell worked.
test_after_hit:
    :PatchJump(calc_spell_failure, test_calc_spell_failure_success)
    jsr test_reset_confusion_state
    jsr player_cast_spell

#importonce
// test_polymorph_other128.s — Focused C128 coverage for the Polymorph Other row
...
test_remove_calls: .byte 0
test_spawn_calls: .byte 0
test_work_idx: .byte 0
test_progress: .byte 0
vis_room_revealed: .byte 0
test_ms_type: .byte 0
test_ms_spawn_x: .byte 0
test_ms_spawn_y: .byte 0
...
test_reset_polymorph_state:
    ...
    sta test_remove_calls
    sta test_spawn_calls
...
test_start:
    ...
    lda test_huff_calls
    bne !t1_fail+
    lda test_remove_calls
    cmp #1
    bne !t1_fail+
    lda test_spawn_calls
    cmp #1
    bne !t1_fail+
    lda test_mon_present
    cmp #1

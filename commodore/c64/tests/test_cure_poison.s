// test_cure_poison.s — Focused runtime tests for the Cure Poison spell row

.pc = $0801 "BASIC Stub"
:BasicUpstart2(test_bootstrap)

.pc = $E000 "Result Buffer"
tcp_results: .fill 3, $ff
...
test_tramp_cure_poison_execute:
...
test_start:
    ...
    :PatchJump(test_spell_execute_selected, test_tramp_cure_poison_execute)
...
!t1_fail:
    ...
    // Test 2: already-clear cast stays silent/no-op, still spends 5 mana,
    // and marks Cure Poison worked.
!t2:
    :PatchJump(calc_spell_failure, test_calc_spell_failure_success)
    jsr test_reset_cure_poison_state
...
!t2_fail:
    ...
    // Test 3: cast failure spends mana, reports failure, preserves poison,
    // and leaves Cure Poison unworked.
!t3:

...
| 12 | Legacy | M2 | Cure Poison | 5/5/35 | 21/9/90 | 11/9/45 | Clear poison | Row-covered on `C64+C128`: focused coverage proves spell-id mapping, poisoned-state clearing through shared `eff_cure_poison`, already-clear silence/no-op behavior, and cast-fail/success mana/worked bookkeeping |
...
| 17 | Added | P3 | Neutralize Poison | 9/6/38 | 15/15/50 | Clear poison | Row-covered on `C64+C128`: focused coverage proves prayer-id mapping, poisoned-state clearing through shared `eff_cure_poison`, already-clear silence/no-op behavior, and cast-fail/success mana/worked bookkeeping |

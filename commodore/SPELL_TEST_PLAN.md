...
| 12 | Cure Poison | M2 | Utility Cleanse | C64+C128 | Cast while poisoned | poison state clears | Dedicated row-level C64/C128 coverage | Yes | Required: not poisoned | current row is silent on successful poison clear/already-clear; cast fail explicit | Timed buff/protection |
...
| 17 | Neutralize Poison | P3 | Utility Cleanse | C64+C128 | Cast while poisoned | poison state clears | Dedicated row-level C64/C128 coverage | Yes | Required: not poisoned | current row is silent on successful poison clear/already-clear; cast fail explicit | Timed buff/protection |

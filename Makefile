.PHONY: all build build64 build128 buildplus4 buildcx16 disk disk64 zip64 c64-dist disk128 diskplus4 artifact artifact-checksums artifacts run run64 run128 runplus4 runcx16 cx16 run-cx16 \
	test test-disk test-disk-static test-disk-debt test64 test128 test128-fast test128-fast-smoke testplus4 testplus4-build testplus4-runtime testcx16-smoke clean \
...
buildcx16 runcx16 testcx16-smoke:

// test_frost_bolt.s — Focused runtime tests for the Frost Bolt spell row
...
test_start:
    ...
    :PatchJump(test_spell_execute_selected, test_tramp_frost_bolt_execute)
    :PatchJump(pm_select_book, test_pm_select_book)
    :PatchJump(pm_prompt_visible_spell_choice, test_pm_prompt_visible_spell_choice)
    :PatchJump(pm_validate_selected_spell, test_pm_validate_selected_spell)

    // Test 1: successful cast reaches spell slot 14, stays message-light,
    // kills the target, spends 6 mana, and marks worked in byte 1.
    :PatchJump(calc_spell_failure, test_calc_spell_failure_success)
    jsr test_reset_frost_bolt_state
...
!t2_fail:
    ...
    // and leaves Frost Bolt unworked.
!t3:

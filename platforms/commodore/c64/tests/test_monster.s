...
//
// Results at $0400-$040e: $01 = pass, $00 = fail per test
...
t9_count:  .byte 0
t9_mask:   .byte 0
tc_results: .fill 15, $ff       // Test results buffer (copied to $0400 by trampoline)
...
!t12_fail:
    ...
    // ==========================================
    // Test 14: E/W movement out of range clears MF_VISIBLE.
    // ==========================================
!t13:
...
!t13_pass:
    ...
    // ==========================================
    // Test 15: N/S movement out of range clears MF_VISIBLE.
    // ==========================================
!t14:
    jsr setup_visibility_axis_test
    lda #15

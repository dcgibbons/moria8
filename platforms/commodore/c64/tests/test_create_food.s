// test_create_food.s — Focused runtime tests for the Create Food spell row
...
test_start:
    ...
    // Test 1: successful cast reaches spell slot 16, replaces any item under
    // the player with a ration, prints CREATE_FOOD, spends 7 mana, and marks
...
!t1_fail:
    ...
    // Test 2: with no free floor-item slot, cast stays explicit on failure,
    // leaves no ration underfoot, still spends mana, and marks the spell
    // worked.
!t2:
    :PatchJump(calc_spell_failure, test_calc_spell_failure_success)
    jsr test_reset_create_food_state

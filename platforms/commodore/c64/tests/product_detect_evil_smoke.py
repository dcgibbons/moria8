...
CONNECTOR_DIR = ROOT / "platforms" / "commodore" / "c128" / "tests"
...
def main() -> int:
    ...
    parser.add_argument("--boot-d64", default=str(ROOT / "build" / "moria8-c64.d64"))
    parser.add_argument("--vs", default=str(ROOT / "build" / "c64" / "main.vs"))

...
.const hal_platform_overlay_count = 10
...
#define HAL_PLATFORM_MONSTER_SPLIT_RESIDENT_SEGMENTS
#define HAL_PLATFORM_MONSTER_VISIBILITY_DIRECT
#define HAL_PLATFORM_DETECT_EVIL_RESIDENT_ITEMS
#define HAL_PLATFORM_LEVELUP_MAGIC_USES_TRAMPOLINE
#define HAL_PLATFORM_CHARGEN_RUNTIME_RESYNC
#define HAL_PLATFORM_CHARACTER_BACKGROUND_RESYNC
#define HAL_PLATFORM_CHARACTER_SHEET_BEGIN_ENABLED
#define HAL_PLATFORM_DESCRIBE_LOOK_MASKS_IRQ
#define HAL_PLATFORM_ITEM_ACTION_KEY_RESTORES_BANK
#define HAL_PLATFORM_REASSERT_BEFORE_MESSAGE_RENDER
#define HAL_PLATFORM_MARK_MODAL_RESTORE_PERF
#define HAL_PLATFORM_RENDER_BALL_EFFECT_DIRECT_PERF
...
// The Huffman corpus rides the Bank 1 $F000 region (read via mmu_safe_db thunks).

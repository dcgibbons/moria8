#importonce
// test_earthquake_prayer128.s — Focused C128 coverage for the Earthquake prayer row
...
test_start:
    ...
    :PatchJump(tramp_spell_execute_selected, test_tramp_earthquake_prayer_execute)
...
test_after_success:
    ...
    lda #2
    sta test_progress
    jmp test_after_low_impact
!t2_fail:
    jmp test_fail

    // Test 3: cast failure spends mana, prints HSTR_PM_FAIL, does not
    // execute, and leaves terrain/reveal state unchanged and unworked.
test_after_low_impact:

...
// Preserves: X, Y
input_get_key:
#if C128_TEST_SCRIPTED_INPUT || C128_TEST_SCRIPTED_SPELL || C128_TEST_SCRIPTED_PRAYER || C128_TEST_SCRIPTED_SPELL_CANCEL || C128_TEST_SCRIPTED_BOOK_OVERLAY || C128_TEST_SCRIPTED_STUDY_BOOK_OVERLAY || C128_TEST_SCRIPTED_SPELL_LIST_OVERLAY || C128_TEST_SCRIPTED_SCROLL_SELECTOR || C128_TEST_SCRIPTED_SAVE_WRITE_PRODUCT || C128_TEST_SCRIPTED_SAVE_MEDIA_FAIL_PRODUCT || C128_TEST_SCRIPTED_CHANGE_SAVE_DRIVE_PRODUCT || C128_TEST_SCRIPTED_SINGLE_DRIVE_SAVE_WRONG_MEDIA_PRODUCT || C128_TEST_SCRIPTED_SINGLE_DRIVE_LOAD_WRONG_MEDIA_PRODUCT || C128_TEST_SCRIPTED_SINGLE_DRIVE_LOAD_CORRUPT_PRODUCT || C128_TEST_SCRIPTED_SINGLE_DRIVE_LOAD_RETURN_PRODUCT || C128_TEST_SCRIPTED_LOAD_THEN_SAVE_NEW_EMPTY_PRODUCT || C128_TEST_SCRIPTED_SINGLE_DRIVE_FRESH_SAVE_PRODUCT || C128_TEST_SCRIPTED_DISK_SETUP_SINGLE_DRIVE_RETURN_PRODUCT || C128_TEST_SCRIPTED_CHEST_OPEN_PRODUCT
...
!igk_wrong_media_pass:
    ...
    jmp c128_test_chest_open_pass_sym
...
#elif C128_TEST_SCRIPTED_CHANGE_SAVE_DRIVE_PRODUCT && !C128_TEST_SCRIPTED_SAVE_WRITE_PRODUCT
    .byte $20              // SPACE = dismiss saved message if shown
    .byte $20              // SPACE = tolerate C128 follow-up modal/fresh-key wait
...
#elif C128_TEST_SCRIPTED_LOAD_THEN_SAVE_NEW_EMPTY_PRODUCT
    .byte $20              // SPACE = acknowledge load save-disk prompt
    .byte $20              // SPACE = acknowledge fresh save-disk prompt

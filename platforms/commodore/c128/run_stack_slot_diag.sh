...
diag_main="../../../build/test/c128/moria128.stackslot.prg"
diag_d64="../../../build/test/c128/moria128_stackslot.d64"
...
if ! java -jar "$KICKASS" main.s -showmem -vicesymbols -libdir ../c64 \
        -define C128 -define OVL_OUT='"../../../build/test/c128"' -define C128_TEST_STACK_SLOT_DIAG \
...
abs_d64="$(cd ../../../build/test/c128 && pwd)/moria128_stackslot.d64"

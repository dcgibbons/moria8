...
| BUG-30 | Combat messages corrupted (garbled PETSCII) for tier-loaded creature names | **Open** — Message area shows garbled PETSCII instead of creature names (e.g., "THE [garbage] HITS", "HAVE SLAIN THE [garbage]"). Observed with 'J' monster on DL:2 and 'P' monster on DL:4. Not symbol-specific — affects multiple creature types across tiers. Likely a Huffman string ID or creature name pointer issue for tier-loaded (non-T0) creatures. |
...
| BUG-30 | **HIGH** | Combat messages corrupted (garbled PETSCII) for tier-loaded creature names | **Open** — Garbled PETSCII instead of creature names in combat messages ("THE [garbage] HITS", "HAVE SLAIN THE [garbage]"). Observed with 'J' on DL:2 and 'P' on DL:4. Affects multiple creature types across tiers — likely Huffman string ID or creature name pointer issue for tier-loaded (non-T0) creatures. |

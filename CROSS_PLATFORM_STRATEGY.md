...
*   **Apple II / CX16 / Apple IIgs:** Fast block device access (ProDOS, FAT32, GS/OS).
*   **Abstraction:** Filesystem access must be moved to an `io_service` layer that abstracts the difference between serial sector reads and block-level file I/O.
...
### The "Resident Overlay" Advantage (Apple IIe, IIgs, CX16)

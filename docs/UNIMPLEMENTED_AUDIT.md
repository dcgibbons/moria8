...
| Balrog victory | Balrog exists as an endgame monster, but ordinary monster death/XP behavior continues after a Balrog kill. | Missing | `docs/BACKLOG.md`; monster roster; combat death path | Backlog item already exists. |
